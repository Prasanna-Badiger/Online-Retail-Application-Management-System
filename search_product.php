  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">Home</a> <!--changed-->
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Products</a>  <!--chaged-->
        </li>
        <li class="nav-item">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-secondary"> <!--changed-->
 ...
 <?php
    ...
    {
    echo "  <li class='nav-item'>
      <a class='nav-link' href='#'>Welcome".$_SESSION['user_name']."</a>  <!--chaged-->
    </li> ";
    }
