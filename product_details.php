  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">Register</a>  <!--chaged-->
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Contact</a>  <!--chaged-->
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Cart<i class="fa-solid fa-cart-shopping"></i><sup>1</sup></a>  <!--chaged-->
        </li>
        <li class="nav-item">
...
<div class="row">
    <div class="col-md-10">
        <div class="row">
            <div class="col-md-4">
            <div class='card' >
      <img src='./images/j4.png' class='card-img-top' alt='$product_title'>
       <div class='card-body'>
     ...
     <!--  <a href='product_details.php?product_id=$product_id' class='btn btn-secondary'>View More</a>-->
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-6">
                    <img src='./images/j2.png' class='card-img-top' alt='$product_title'>
                    </div>
                    <div class="col-md-6">
                    <img src='./images/j3.png' class='card-img-top' alt='$product_title'>  
                     </div>
                </div>
